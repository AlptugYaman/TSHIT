<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Kadin.aspx.cs" Inherits="TISHT.Kadin" %>
...
<%--                               <asp:ImageButton ID="imgResim" ImageUrl='<%#Eval("resimyolu1")%>' runat="server"
                                    AlternateText='<%#Eval("urunadi")%>' CssClass="img-thumbnail" /><br />--%>
<asp:ImageButton runat="server" ID="imgResim" ImageUrl='<%#Eval("resimyolu1")%>'
                               ...
                               <asp:Label ID="lblFiyat" runat="server" Text='<%#Eval("birimfiyat")%> ' CssClass="label label-success" ></asp:Label>
                                <asp:Button ID="btnEkle" runat="server" Text="Sepete Ekle" CommandName="asd" CssClass="btn btn-primary btn-info " />
                                <br />
                                <br />
                                <br />
                                <br />
